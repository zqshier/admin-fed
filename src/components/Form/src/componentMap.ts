...
componentMap.set('ImageUploadGroup', ImageUploadGroup);
componentMap.set('VideoUpload', VideoUpload);
componentMap.set('FileUpload', FileUpload);
componentMap.set('RegInput', RegInput);
componentMap.set('RangeInput', RangeInput);
componentMap.set('DatePickerEx', DatePickerEx);
componentMap.set('RangePickerEx', RangePickerEx);
