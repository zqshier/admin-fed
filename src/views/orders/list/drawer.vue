<template>
  <BasicDrawer v-bind="$attrs" @register="registerDrawer" title="订单详情" :isDetail="true">
    <div class="top-info">
      <div class="title">
            ...
            <div class="pane">
              ...
              <div class="con">
                ...
                <!-- <a-descriptions :column="1" size="middle">
                  <a-descriptions-item label="运单号">{{ parcel.logisticNo }}</a-descriptions-item>
                  <a-descriptions-item label="物流公司名称">{{
                    parcel.logisticCode
                  }}</a-descriptions-item>
                  <a-descriptions-item label="发货导购">{{
                    parcel.logisticNo
                  }}</a-descriptions-item>
                  <a-descriptions-item label="发货门店">{{
                    parcel.logisticNo
                  }}</a-descriptions-item>
                </a-descriptions> -->
              </div>
              ...
              <!--div class="con">
                <a-timeline>
                  <a-timeline-item color="green">
                    <div>2022/07/14 10:00:00</div>
                    <div>离开【北京】，下一站【上海】</div>
                  </a-timeline-item>
                  <a-timeline-item color="green">
                    <div>2022/07/14 10:00:00</div>
                    <div>离开【北京】，下一站【上海】</div>
      ...
      <template #bodyCell="{ column, record }">
        ...
        >
          ...
          <p v-if="record.aftersaleItemStatus.itemStatus.serveStatus === 'noserving'"
            ><Tag>无退款</Tag></p
          >
          <!-- <p>{{ goodsServeStatusNames[record.aftersaleItemStatus.itemStatus.serveStatus] }}</p> -->
...
<script lang="ts" setup>
  ...
  import { ordersDetail, ordersAftersaleItemStatus, ordersCancel } from '/@/api/app/orders';
  ...
  const [registerDrawer, { setDrawerProps }] = useDrawerInner(async (data) => {
    try {
      ...
      await getOrderDetail(data.orderNo);
